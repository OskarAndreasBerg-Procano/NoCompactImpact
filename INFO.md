# NoCompactImpact — reference

Technical reference for the `context-relay` plugin. For installation and day-to-day use,
...
- Auto-compact enabled (see [README.md](README.md)).
